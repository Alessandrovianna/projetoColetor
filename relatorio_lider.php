...
<html lang="en">
    ...
    <body class="body-relatorios">
        <div class="div-form-buscar">
            <form method="POST">
                <input class="input-buscar" type="text" name="buscar" autocomplete="off" placeholder="Digite o nome do Lider..." autofocus />
        ...
        <table class="tabela-usuarios" border="0" width="80%">
            ...
            if(isset($_POST['buscar'])){
                $sql = "SELECT * FROM usuarios_dos_coletores WHERE CONCAT(lider) LIKE '%".$_POST['buscar']."%'";
            }else{
